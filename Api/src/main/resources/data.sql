...
insert into BlogPost (id,userId, title, content, lastEditedOn, author, enabled)
    values (1,'347be14c5-c7f3-417c-abce-526547d1d486','Sample blog post', 'This is sample blog post entered manually in database', '2019-11-01','admin',0);
insert into BlogPost (id,userId, title, content, lastEditedOn, author)
    values (2,'39f9141a-20ed-402b-8972-2d9a6fb46c6c','Happy New Year!', 'Some new stuff in new year', '2020-01-01','admin');
insert into BlogPost (id,userId, title, content, lastEditedOn, author)
    values (3,'017a0d44-1b0e-496b-84b5-de4ac3a645df','Maverick Sample blog post', 'Maverick was here...', '2019-12-01','Maverick');
insert into BlogPost (id,userId, title, content, lastEditedOn, author)
    values (4,'8b7d2a9d-953d-46ee-be09-c8eb12bbe60f','Goose Sample blog post', 'Goose was here...', '2019-10-01','Goose');
insert into BlogPost (id,userId, title, content, lastEditedOn, author)
    values (5,'1da792b5-9954-4f4d-bb1a-afd2ba049410','Goose changes partner!', 'Goose changed partner..', '2019-12-01','Goose');
insert into BlogPost (id,userId, title, content, lastEditedOn, author, enabled)
    values (6,'864d820bc-163e-42a6-9c0a-de38e44d95f8','Goose gets killed!', 'Goose is no more', '2019-12-02','Goose',0);
